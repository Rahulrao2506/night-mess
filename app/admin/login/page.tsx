...
export default function AdminLogin() {
  ...
  const handleLogin = async () => {
    ...
    if (match) {
      sessionStorage.setItem("nm_admin", JSON.stringify({
      ...
      >
          ...
          <div style={{ position: "relative" }}>
            <input
              ...
              style={{
                width: "100%", background: "#0a0a0a",
                border: "1px solid #222", borderRadius: 12,
                padding: "13px 44px 13px 14px", color: "#fff",
                fontSize: 14, outline: "none", boxSizing: "border-box" as const
              }}
            />
            <button
        ...
        <button
          ...
          style={{
            ...
            background: loading ? "#1a1a1a" : "linear-gradient(135deg, #ff6b35, #ff9a3c)",
        ...
        <div style={{
          ...
          This page is for mess staff only.{" "}
          Students go to{" "}
          <a href="/login" style={{ color: "#ff6b35", textDecoration: "none" }}>
            /login
          </a>
        </div>
      </motion.div>
